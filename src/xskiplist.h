...
typedef void(*xskiplist_node_value_free_func)(void *ptr);
// \return 0: equal; -1: less; 1: greater.
typedef int(*xskiplist_node_value_cmp_func)(void *ptr, void *value);
...
typedef struct xskiplist {
    ...
    xskiplist_node_value_free_func free;
    xskiplist_node_value_cmp_func cmp;
} xskiplist;
...
static inline void xskiplist_set_free_func(xskiplist *list, xskiplist_node_value_free_func free) { list->free = free; }
static inline void xskiplist_set_cmp_func(xskiplist *list, xskiplist_node_value_cmp_func cmp) { list->cmp = cmp; }
